...
import com.storeapi.orders.OrderItem;
...
public class StripePaymentGateway implements PaymentGateway {
  ...
  @Override
  public Optional<CheckoutController.PaymentResult> parseWebhookRequest(WebhookRequest webhookRequest) {
    try {
      ...
      return switch (event.getType()) {
        case "payment_intent.succeeded" -> Optional.of(new CheckoutController.PaymentResult(orderId, PaymentStatus.PAID));
        case "payment_intent.payment_failed" -> Optional.of(new CheckoutController.PaymentResult(orderId, PaymentStatus.FAILED));
